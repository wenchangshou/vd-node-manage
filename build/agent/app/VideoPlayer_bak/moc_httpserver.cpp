...
#include "../../ZOOLON_VideoPlayer/httpserver.h"
...
QT_MOC_LITERAL(4, 29, 3) // "str"
    ...
    "HttpServer\0RecvMsg\0\0QString*\0str"
};
...
void HttpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (HttpServer::*)(QString * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HttpServer::RecvMsg)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void HttpServer::RecvMsg(QString * _t1)
{
